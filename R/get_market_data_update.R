  ...
  save_market_data_update <- function(symbols, save_path = 'D:/market_data/equity/usa/hour/trades') {
    for (symbol in symbols) {
      print(symbol)
      new_data <- get_market_equities(symbol, from = Sys.Date() - 5, to = Sys.Date(), api_key = API_KEY)
  ...
  file.copy(list.files('D:/market_data/equity/usa/hour/trades', full.names = TRUE),
            'C:/Users/Mislav/Documents/GitHub/lean_test/data/equity/usa/hour',
            overwrite = TRUE)
  file.copy(list.files('D:/market_data/equity/usa/hour/trades', full.names = TRUE),
            'C:/Users/Mislav/Documents/GitHub/exuber_live/data/equity/usa/hour',
            overwrite = TRUE)
